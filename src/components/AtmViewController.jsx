...
export default function AtmViewController(){
    ...
    return (
        <Box sx={{textAlign:"center"}}>
            ...
            <Box sx ={{m:"20px"}}>
                <Button onClick={() => setAtmState(true)} sx ={{mr:"20px", backgroundColor:"#f44336"}}>Withdraw</Button>
                <Button onClick={() => setAtmState(false)} sx ={{ml:"20px" ,backgroundColor:"#81c784"}} >Deposit</Button>
            </Box>
            <>
                {
                    atmState ? 
